      ...
      <div className="grid xl:grid-cols-3 xl:grid-rows-2 gap-8">
        <div className="relative xl:col-span-2 xl:row-start-1 xl:row-end-[-1]">
          ...
          <div className="absolute max-w-[470px] sm:ml-16 ml-8 top-[30%] sm:space-y-2">
            <h2 className="text-2xl hidden sm:block text-gray-600">
              The best food delivery service
            </h2>
            <p className="text-6xl sm:text-4xl md-text-8xl font-bold text-gray-800">
              Best Food Delivery
            </p>
            <p className="text-gray-800 text-xl pt-4 sm:pt-8">Starting At</p>
        ...
        <div className="relative">
          ...
          <div className="absolute max-w-[470px] sm:ml-16 ml-8 top-[10%] sm:space-y-1">
            <h2 className="text-2xl hidden sm:text-3xl font-bold text-secondary">
              The best food facility
            </h2>
            <p className="text-2xl sm:text-3xl md-text-8xl pt-2 text-secondary">
              Best Sushi
            </p>
